...
const translations = {
    fr: {
        ...
        "works.title": "Réalisations d'architecture",
        "works.note": "Schémas issus de missions réelles, anonymisés. Cliquer pour agrandir.",
        "works.d2a.title": "Data-to-App : de la plateforme à l'application",
        "works.d2a.desc": "Boucle complète : mirroring des bases opérationnelles, datalake hub & spoke (bronze centralisé, data products gold par domaine), synchronisation vers une base de lecture Cosmos et exposition via APIs à l'application.",
        "works.acc.title": "Pipeline accounting haute volumétrie",
        "works.acc.desc": "Chaîne end-to-end : flux partenaires (SFTP), pipelines d'ingestion, streaming near-realtime Databricks vers l'application métier, jobs de comptabilisation et export vers l'ERP — plus de 10 M de lignes par semaine.",
        "works.hybrid.title": "Data Platform hybride Fabric / Databricks",
        "works.hybrid.desc": "Mirroring zéro-ETL des bases opérationnelles vers OneLake, Lakehouse médaillon gouverné par Unity Catalog, restitution Power BI en Direct Lake.",
        "works.mesh.title": "Data Mesh multi-domaines sur Databricks",
        "works.mesh.desc": "Domaines data autonomes (monétique, bénéficiaires, loyalty) en architecture médaillon, publication et consommation des data products via Unity Catalog.",
        "works.es.title": "Référentiel métier event-sourcé sur Azure",
        "works.es.desc": "Référentiel critique d'une ligue sportive : Event Sourcing, read models SQL, intégration fédération, messagerie Event Grid, observabilité et décisions d'architecture tracées.",
        "works.sls.title": "Assessment serverless Databricks (FinOps)",
        "works.sls.desc": "Étude d'arbitrage jobs continus vs planifiés : éligibilité serverless par taille de workload et usage d'UDF, contraintes et stratégie de migration.",
        "nav.contact": "Contact",
        ...
        "about.intro": "Architecte Data avec plus de <strong>13 ans d'expérience</strong>, expert <strong>Databricks</strong>, <strong>Microsoft Fabric</strong> et <strong>Azure</strong>. Je conçois et pilote des data platforms d'entreprise (Lakehouse, Unity Catalog, Data Mesh) et des pipelines batch et temps réel à forte volumétrie avec Spark.",
        "about.desc2": "J'interviens sur des projets stratégiques avec une forte exigence métier, en assurant gouvernance et qualité des données, performance et optimisation des coûts (FinOps). Mon rôle transverse m'amène à <strong>encadrer les équipes data</strong> et à structurer les standards d'architecture et d'ingénierie.",
    ...
    en: {
        ...
        "works.title": "Architecture case studies",
        "works.note": "Diagrams from real assignments, anonymized. Click to enlarge.",
        "works.d2a.title": "Data-to-App: from platform to application",
        "works.d2a.desc": "Full loop: mirroring of operational databases, hub & spoke datalake (centralized bronze, gold data products per domain), sync to a Cosmos read store and API exposure to the application.",
        "works.acc.title": "High-volume accounting pipeline",
        "works.acc.desc": "End-to-end chain: partner flows (SFTP), ingestion pipelines, Databricks near-realtime streaming to the business application, accounting jobs and export to the ERP — over 10M rows per week.",
        "works.hybrid.title": "Hybrid Fabric / Databricks Data Platform",
        "works.hybrid.desc": "Zero-ETL mirroring of operational databases to OneLake, medallion Lakehouse governed by Unity Catalog, Power BI reporting in Direct Lake.",
        "works.mesh.title": "Multi-domain Data Mesh on Databricks",
        "works.mesh.desc": "Autonomous data domains (payments, beneficiaries, loyalty) with medallion architecture, data products published and consumed through Unity Catalog.",
        "works.es.title": "Event-sourced business referential on Azure",
        "works.es.desc": "Critical referential for a professional sports league: Event Sourcing, SQL read models, federation integration, Event Grid messaging, observability and traced architecture decisions.",
        "works.sls.title": "Databricks serverless assessment (FinOps)",
        "works.sls.desc": "Trade-off study for continuous vs scheduled jobs: serverless eligibility by workload size and UDF usage, constraints and migration strategy.",
        "nav.contact": "Contact",
        ...
        "about.who": "Who am I?",
        "about.intro": "Data Architect with over <strong>13 years of experience</strong>, expert in <strong>Databricks</strong>, <strong>Microsoft Fabric</strong> and <strong>Azure</strong>. I design and lead enterprise data platforms (Lakehouse, Unity Catalog, Data Mesh) and high-volume batch and real-time pipelines with Spark.",
        "about.desc2": "I work on strategic projects with high business requirements, ensuring data governance and quality, performance, and cost optimization (FinOps). My cross-functional role leads me to <strong>mentor data teams</strong> and establish architecture and engineering standards.",
